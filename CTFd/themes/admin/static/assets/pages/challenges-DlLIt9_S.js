import{$ as e,u as c,C as n,B as r}from"./main-CZXvrO_z.js";function h(d){let i=e("input[data-challenge-id]:checked").map(function(){return e(this).data("challenge-id")}),a=i.length===1?"challenge":"challenges";c({title:"Delete Challenges",body:`Are you sure you want to delete ${i.length} ${a}?`,success:function(){const t=[];for(var l of i)t.push(n.fetch(`/api/v1/challenges/${l}`,{method:"DELETE"}));Promise.all(t).then(o=>{window.location.reload()})}})}function p(d){let i=e("input[data-challenge-id]:checked").map(function(){return e(this).data("challenge-id")}),a=e("input[data-challenge-id]:checked").map(function(){return e(this).data("solution-id")});r({title:"Edit Challenges",body:e(`
